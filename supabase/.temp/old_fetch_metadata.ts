...
Deno.serve(async (req: Request) => {
    ...
    try {
        ...
        if (html.includes('api-services-support@amazon.com') ||
            ...
            html.includes('Digite os caracteres que voc├¬ v├¬ na imagem abaixo')) {
            throw new Error('Anti-bot da Amazon bloqueou a extra├º├úo. Tente novamente ou use inser├º├úo manual.');
        }
